...
Source0  : https://download.kde.org/stable/release-service/25.04.1/src/pim-data-exporter-25.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.1/src/pim-data-exporter-25.04.1.tar.xz.sig
...
%setup -q -n pim-data-exporter-25.04.1
cd %{_builddir}/pim-data-exporter-25.04.1
pushd ..
cp -a pim-data-exporter-25.04.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747189833
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libpimdataexporterprivate.so.6.4.1
/usr/lib64/libpimdataexporterprivate.so.6
/usr/lib64/libpimdataexporterprivate.so.6.4.1
