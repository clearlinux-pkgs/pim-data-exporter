...
%prep
%setup -q -n pim-data-exporter-19.12.0
cd %{_builddir}/pim-data-exporter-19.12.0
...
cp %{_builddir}/pim-data-exporter-19.12.0/COPYING.DOC %{buildroot}/usr/share/package-licenses/pim-data-exporter/1bd373e4851a93027ba70064bd7dbdc6827147e1
cp %{_builddir}/pim-data-exporter-19.12.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/pim-data-exporter/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
...
/usr/lib64/libpimdataexporterprivate.so.5.13.0
