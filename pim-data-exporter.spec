...
Source0  : https://download.kde.org/stable/release-service/24.02.2/src/pim-data-exporter-24.02.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.2/src/pim-data-exporter-24.02.2.tar.xz.sig
...
%setup -q -n pim-data-exporter-24.02.2
cd %{_builddir}/pim-data-exporter-24.02.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712961255
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libpimdataexporterprivate.so.6.0.2
/usr/lib64/libpimdataexporterprivate.so.6
/usr/lib64/libpimdataexporterprivate.so.6.0.2
