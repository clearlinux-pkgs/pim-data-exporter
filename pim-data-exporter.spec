...
Version  : 20.08.3
Release  : 26
URL      : https://download.kde.org/stable/release-service/20.08.3/src/pim-data-exporter-20.08.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/20.08.3/src/pim-data-exporter-20.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.08.3/src/pim-data-exporter-20.08.3.tar.xz.sig
...
%prep
%setup -q -n pim-data-exporter-20.08.3
cd %{_builddir}/pim-data-exporter-20.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1604625709
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/pim-data-exporter-20.08.3/COPYING %{buildroot}/usr/share/package-licenses/pim-data-exporter/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/pim-data-exporter-20.08.3/COPYING.DOC %{buildroot}/usr/share/package-licenses/pim-data-exporter/1bd373e4851a93027ba70064bd7dbdc6827147e1
cp %{_builddir}/pim-data-exporter-20.08.3/COPYING.LIB %{buildroot}/usr/share/package-licenses/pim-data-exporter/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
...
/usr/lib64/libpimdataexporterprivate.so.5.15.3
