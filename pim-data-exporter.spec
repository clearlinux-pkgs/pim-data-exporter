...
Source0  : https://download.kde.org/stable/release-service/22.12.1/src/pim-data-exporter-22.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.1/src/pim-data-exporter-22.12.1.tar.xz.sig
...
%prep
%setup -q -n pim-data-exporter-22.12.1
cd %{_builddir}/pim-data-exporter-22.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673388560
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/pim-data-exporter-%{version}/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/pim-data-exporter/c085897bc39e05746ffd2d889a6e84ff1b7ae2d9 || :
...
/usr/lib64/libpimdataexporterprivate.so.5.22.1
...
/usr/share/package-licenses/pim-data-exporter/c011fda7746c087a127999da1c4044854ee42238
