...
Version  : 19.08.1
Release  : 11
URL      : https://download.kde.org/stable/applications/19.08.1/src/pim-data-exporter-19.08.1.tar.xz
Source0  : https://download.kde.org/stable/applications/19.08.1/src/pim-data-exporter-19.08.1.tar.xz
Source1 : https://download.kde.org/stable/applications/19.08.1/src/pim-data-exporter-19.08.1.tar.xz.sig
...
%prep
%setup -q -n pim-data-exporter-19.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1567758095
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libpimdataexporterprivate.so.5.12.1
