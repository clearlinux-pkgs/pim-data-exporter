...
Version  : 19.04.2
Release  : 8
URL      : https://download.kde.org/stable/applications/19.04.2/src/pim-data-exporter-19.04.2.tar.xz
Source0  : https://download.kde.org/stable/applications/19.04.2/src/pim-data-exporter-19.04.2.tar.xz
Source99 : https://download.kde.org/stable/applications/19.04.2/src/pim-data-exporter-19.04.2.tar.xz.sig
...
%prep
%setup -q -n pim-data-exporter-19.04.2
...
export LANG=C
export SOURCE_DATE_EPOCH=1559938299
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
...
/usr/lib64/libpimsettingexporterprivate.so.5.11.2
