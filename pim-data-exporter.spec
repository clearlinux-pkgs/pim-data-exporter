...
Source0  : https://download.kde.org/stable/release-service/22.12.0/src/pim-data-exporter-22.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.0/src/pim-data-exporter-22.12.0.tar.xz.sig
...
%prep
%setup -q -n pim-data-exporter-22.12.0
cd %{_builddir}/pim-data-exporter-22.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670786816
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libpimdataexporterprivate.so.5.22.0
