...
Source0  : https://download.kde.org/stable/release-service/22.08.2/src/pim-data-exporter-22.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.2/src/pim-data-exporter-22.08.2.tar.xz.sig
...
%prep
%setup -q -n pim-data-exporter-22.08.2
cd %{_builddir}/pim-data-exporter-22.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665781765
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libpimdataexporterprivate.so.5.21.2
