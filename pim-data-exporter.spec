...
Version  : 19.08.2
Release  : 12
URL      : https://download.kde.org/stable/applications/19.08.2/src/pim-data-exporter-19.08.2.tar.xz
Source0  : https://download.kde.org/stable/applications/19.08.2/src/pim-data-exporter-19.08.2.tar.xz
Source1 : https://download.kde.org/stable/applications/19.08.2/src/pim-data-exporter-19.08.2.tar.xz.sig
...
%prep
%setup -q -n pim-data-exporter-19.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1570782704
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libpimdataexporterprivate.so.5.12.2
