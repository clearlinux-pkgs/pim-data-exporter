...
%setup -q -n pim-data-exporter-24.12.0
cd %{_builddir}/pim-data-exporter-24.12.0
pushd ..
cp -a pim-data-exporter-24.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735342892
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libpimdataexporterprivate.so.6.3.0
/usr/lib64/libpimdataexporterprivate.so.6
/usr/lib64/libpimdataexporterprivate.so.6.3.0
